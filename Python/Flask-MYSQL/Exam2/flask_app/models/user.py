...
class User:
    ...
    def validate_user(data):
        ...
        if len(data['first_name']) < 2:
            flash("First name should be at least 2 characters!", 'first_nameRegister')
            is_valid = False
        if len(data['last_name']) < 2:
            flash("Last name should be at least 2 characters!", 'last_nameRegister')
            is_valid = False
